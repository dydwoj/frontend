...
console.log("추가 후 : ", deepCopy.toString());
...
console.log("합친 후 1 : ", newArr);

let toArr = [varArr1, varArr2];
let toArr2 = [...varArr1, ...varArr2];
console.log("합친 후 2 : ", toArr);
varArr1[0] = "num5";
console.log("varArr1[0] 변경 후 : ", varArr1);
console.log("varArr1[0] 변경 후 (주소) : ", toArr);
console.log("varArr1[0] 변경 후 (값) : ", toArr2);
